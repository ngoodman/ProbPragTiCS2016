...
%TODO (global... others are inline in comments):
%
%I believe that the reviewer's request to discuss potential drawbacks of the RSA/uRSA approach at least briefly is a good one. In the absence of a discussion of alternate approaches or potential shortcomings of this approach, the article currently reads more as an Opinion than a Review. Although we have the option of converting to an Opinion in the process of the revision, I think the piece would be more useful and impactful if this topic were at least briefly addressed. Please ensure that the revised main text does not exceed 4,150 words and 130 references (if a Review) or contact me to discuss if this is insufficient.
%
%
%
%TODO (formatting):
...
%In the revised manuscript, please use Trends citation style ? numbered and in brackets. See TiCS website for formatting information.

%go through becca's highlighted terms and add to glossary or simplify.

%get box numbering right.

%trends and OQ as separate files.
...
affairs (i.e. a truth-function on possible worlds). 
...
$P_S$ and $P_L$ correlated very strongly with participants' average bets on what to say and how to interpret, respectively. 
...
semantic systems to jointly infer word meanings and world state \citep{bergen2016,potts2015} showed a good fit to the overall pattern of data, however, supporting the idea that uRSA is a fruitful way to incorporate pragmatic reasoning into compositional systems.
